...
public class FamiliarHorseElement extends ModelElement {
    ...
    private void applyHorseAnimations(EntityRendererProvider.Context context, HorseRenderer horseRenderer) {
        setAnimatedAgeableModel(horseRenderer, new FamiliarHorseModel(context.bakeLayer(this.animatedHorse)));
        applyLayerAnimation(horseRenderer, context, (RenderLayer<HorseRenderState, HorseModel> renderLayer) -> {
    ...
    private void applyEquineAnimations(EntityRendererProvider.Context context, DonkeyRenderer<?> donkeyRenderer, ModelLayerLocation modelLayer, ModelLayerLocation saddleLayer, EquipmentClientInfo.LayerType layerType) {
        setAnimatedAgeableModel(donkeyRenderer, new FamiliarDonkeyModel(context.bakeLayer(modelLayer)));
        applyLayerAnimation(donkeyRenderer, context, (RenderLayer<DonkeyRenderState, DonkeyModel> renderLayer) -> {
