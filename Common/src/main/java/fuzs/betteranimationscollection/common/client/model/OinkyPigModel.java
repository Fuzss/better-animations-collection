...
import fuzs.betteranimationscollection.common.client.element.OinkyPigElement;
...
public class OinkyPigModel extends PigModel {
    ...
    public void setupAnim(LivingEntityRenderState state) {
        ...
        if (OinkyPigElement.floatyEars) {
            float flapAnimationPos = state.ageInTicks * 0.1F + state.walkAnimationPos * 0.5F;
            float flapAnimationSpeed = 0.08F + state.walkAnimationSpeed * OinkyPigElement.earAnimationSpeed * 0.04F;
