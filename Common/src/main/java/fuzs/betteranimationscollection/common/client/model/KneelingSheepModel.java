...
public class KneelingSheepModel extends SheepModel {
    ...
    public KneelingSheepModel(ModelPart modelPart) {
        super(modelPart);
        this.rightFrontLowerLeg = modelPart.getChild("right_front_leg").getChild("right_front_lower_leg");
        this.leftFrontLowerLeg = modelPart.getChild("left_front_leg").getChild("left_front_lower_leg");
    }
