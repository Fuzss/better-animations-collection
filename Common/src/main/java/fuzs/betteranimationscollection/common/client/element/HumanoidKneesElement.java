...
import fuzs.betteranimationscollection.common.client.model.DrownedKneesModel;
import fuzs.betteranimationscollection.common.client.model.HumanoidKneesModel;
import fuzs.betteranimationscollection.common.client.model.PiglinKneesModel;
import fuzs.betteranimationscollection.common.client.model.ZombieKneesModel;
...
public class HumanoidKneesElement extends ModelElement {
    ...
    protected void applyModelAnimations(LivingEntityRenderer<?, ?, ?> entityRenderer, EntityRendererProvider.Context context) {
        if (entityRenderer.getModel().getClass() == ZombieModel.class) {
            this.setAnimatedAgeableModel((AgeableMobRenderer<?, ZombieRenderState, ZombieModel<ZombieRenderState>>) entityRenderer,
                    new ZombieKneesModel(context.bakeLayer(this.animatedZombie)));
            this.applyLayerAnimation((LivingEntityRenderer<?, ZombieRenderState, ZombieModel<ZombieRenderState>>) entityRenderer,
                    context,
        ...
        if (entityRenderer.getModel().getClass() == DrownedModel.class) {
            this.setAnimatedAgeableModel((AgeableMobRenderer<?, ZombieRenderState, DrownedModel>) entityRenderer,
                    new DrownedKneesModel(context.bakeLayer(this.animatedDrowned)));
            this.applyLayerAnimation((LivingEntityRenderer<?, ZombieRenderState, DrownedModel>) entityRenderer,
                    context,
        ...
        if (entityRenderer.getModel().getClass() == PiglinModel.class) {
            this.setAnimatedAgeableModel((AgeableMobRenderer<?, PiglinRenderState, PiglinModel>) entityRenderer,
                    new PiglinKneesModel(context.bakeLayer(this.animatedPiglin)));
            this.applyLayerAnimation((LivingEntityRenderer<?, HumanoidRenderState, HumanoidModel<HumanoidRenderState>>) entityRenderer,
                    context,
