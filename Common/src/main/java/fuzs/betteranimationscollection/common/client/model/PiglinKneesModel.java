...
public class PiglinKneesModel extends AdultPiglinModel implements KneesModel {
    ...
    public static LayerDefinition createAnimatedBodyLayer() {
        return AdultPiglinModel.createBodyLayer().apply((MeshDefinition meshDefinition) -> {
