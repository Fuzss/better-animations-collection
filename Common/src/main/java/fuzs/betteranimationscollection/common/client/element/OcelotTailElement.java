...
public class OcelotTailElement extends SingletonModelElement<Ocelot, FelineRenderState, AbstractFelineModel<FelineRenderState>> {
    ...
    @Override
    protected void setAnimatedModel(LivingEntityRenderer<?, FelineRenderState, AbstractFelineModel<FelineRenderState>> entityRenderer, EntityRendererProvider.Context context) {
