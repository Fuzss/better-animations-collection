...
public abstract class ModelElement implements ModelLayerFactory {
    ...
    protected final <S extends LivingEntityRenderState, M extends EntityModel<? super S>> void applyLayerAnimation(LivingEntityRenderer<?, S, M> entityRenderer, EntityRendererProvider.Context context, LayerMutator<S, M> mutator) {
    ...
    protected final <S extends LivingEntityRenderState, M extends EntityModel<? super S>> void setAnimatedAgeableModel(AgeableMobRenderer<?, ?, ?> ageableRenderer, M adultModel) {
